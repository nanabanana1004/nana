def greet():
    '''Создаем функцию для приветствия'''
    print('~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
def ask():
    '''Создаем функцию для взаимодействия с пользователем'''
    while True:
        ...
        if 0 < x > 2 or 0 < y > 2: #Проверка на вхождение в диапазон
...
greet() #Вызываем функцию приветствия
move = 0
